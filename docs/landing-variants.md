...
| 복제1 | `free-evening/index.html` | `/free-evening/` | 2026.7.9(목) 오후 8:30 무료특강 | `https://forms.gle/KL7f6uJcr5PsS5gd7` |
| 복제2 회원용 | `member-morning/index.html` | `/member-morning/` | 2026.7.9(목) 오전 10:00 회원용 무료특강 | `https://forms.gle/kXLPUULzuxeb32mA9` |

## 운영 원칙

- 같은 클래스 정보와 금액은 유지하고, 특강 일시·얼리버드 마감·신청 폼만 페이지별로 분리한다.
- 모든 페이지 상단에 `운영 구분` 바를 두어 기존/복제1/복제2를 즉시 구분한다.
